...
```bash
go test -count=1 ./lib/api/httpclient/... ./lib/api/logger/plug/...
go test -race -count=20 ./lib/api/httpclient/... ./lib/api/logger/plug/...
govulncheck ./...
...
```bash
go test -count=50 ./lib/api/httpclient/... ./lib/web/http_client/... ./lib/web/web_gin/...
go test -race -count=20 ./lib/api/httpclient/... ./lib/web/http_client/... ./lib/web/web_gin/...
```
