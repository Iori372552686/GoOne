...
// 	protoc        v6.33.2
// source: service/mysqlservice.proto
...
var File_service_mysqlservice_proto protoreflect.FileDescriptor
...
func file_service_mysqlservice_proto_init() {
	if File_service_mysqlservice_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_service_mysqlservice_proto_rawDesc), len(file_service_mysqlservice_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_service_mysqlservice_proto_goTypes,
		DependencyIndexes: file_service_mysqlservice_proto_depIdxs,
	}.Build()
	File_service_mysqlservice_proto = out.File
	file_service_mysqlservice_proto_goTypes = nil
	file_service_mysqlservice_proto_depIdxs = nil
}
